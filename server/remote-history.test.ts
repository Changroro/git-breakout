  ...
  it("parses persisted repository observations", () => {
    expect(parseCollectionContext({
      ...
      repositories: [{
        ...
        latest_rank: 2,
        latest_stars: 42,
        first_observed_stars: 12,
        first_observation_was_trending: false,
        official_trending_episode_count: 0,
        growth_comparison_captured_at: "2026-08-20T08:00:00.000Z",
      ...
      repositories: [{
        ...
        latestRank: 2,
        latestStars: 42,
        firstObservedStars: 12,
        firstObservationWasTrending: false,
        officialTrendingEpisodeCount: 0,
        growthComparisonCapturedAt: "2026-08-20T08:00:00.000Z",
      ...
      repositories: [
        {
          ...
          first_observation_was_trending: false,
          official_trending_episode_count: 0,
          growth_comparison_captured_at: null,
